...
import app.proto.library_pb2 as library__pb2
...
class LibraryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListBorrowings = channel.unary_unary(
                ...
                request_serializer=library__pb2.ListBorrowingsRequest.SerializeToString,
                response_deserializer=library__pb2.ListBorrowingsResponse.FromString,
                _registered_method=True)
...
def add_LibraryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListBorrowings': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=library__pb2.ListBorrowingsRequest.FromString,
                    response_serializer=library__pb2.ListBorrowingsResponse.SerializeToString,
            ),
    }
...
class LibraryService(object):
    ...
    def ListBorrowings(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/library.LibraryService/ListBorrowings',
            library__pb2.ListBorrowingsRequest.SerializeToString,
            library__pb2.ListBorrowingsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
