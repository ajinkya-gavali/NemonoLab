...
export const listAvailableBooks = () => api.get('/available-books').then(res => res.data);

export const listMembers = () => api.get('/members').then(res => res.data); // Moved to named export
...
export default {
  ...
  // listMembers is now a named export
